...
\subsection{Results in Random Scenarios}
  ...
  Greedy Searches behave better than the base Sparrow algorithm.  There
  are two main differences between using Random Walks and Greedy
  Searches:
  \begin{itemize}
  ...
  In conclusion, we would expect better results in a Gradient Search for a
  deployment composed by homogeneous nodes. As a drawback we would need
  a complex ranking function and to increase the message frequency for
  Cyclon
