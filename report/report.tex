...
\section{Experimental evaluation}\label{sec:Evaluation}
  ...
  \begin{itemize}
    ...
    \item A random scenario (\scenario{B}) similar to A but tasks have
    ...
    \item A random scenario (\scenario{C}) similar to A but with
      heterogeneous nodes resources.

  \end{itemize}

  Except for scenario \scenario{B}, all of them are generated using the CPU
